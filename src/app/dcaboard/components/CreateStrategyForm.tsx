...
export function CreateStrategyForm({
  ...
  return (
    <form className={`flex flex-col gap-4 ${isAiModified ? 'border-2 border-[hsl(var(--sky-300)/0.4)] bg-[hsl(var(--sky-300)/0.05)] p-4 rounded-none' : ''}`} onSubmit={onSubmit}>
      ...
      {!isAiModified && (
        <div className='flex items-center gap-2 rounded-sm bg-[hsl(var(--sky-300)/0.1)] p-2 border border-[hsl(var(--sky-300)/0.2)]'>
          <div className='flex items-center justify-center w-5 h-5 rounded-full bg-[hsl(var(--sky-300)/0.2)] text-[hsl(var(--sky-300))]'>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5 10 10 0 0 0-10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5 10 10 0 0 0-10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5" />
              <path d="M9.5 9.5 8 8" />
              <path d="M14.5 9.5 16 8" />
              <path d="M12 16v-2" />
            </svg>
          </div>
          <p className='text-[10px] text-[hsl(var(--sky-300))] font-medium'>
            All strategies are reviewed by Hodloth AI before activation.
          </p>
        </div>
      )}
      ...
      <div className='mt-2 flex justify-end'>
        <button
          ...
          className={`inline-flex items-center justify-center px-4 py-2 text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${isAiModified
              ? 'bg-[hsl(var(--sky-300))] text-black hover:bg-[hsl(var(--sky-300)/0.9)]'
